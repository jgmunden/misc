bottom.contact.groundfish = function(x, n.req=30, sd.fraction=1, method="variance", gam.smooth.var="depth", kernel=c(3,3), inla.model="ar1" ) {
  
  # n.req=30;sd.fraction=1;method="variance";gam.smooth.var="depth";kernel=c(3,3);inla.model="ar1"
  ...
  # reset in case there were NA's created inside the fishing period
  x$rowindex =1:nrow(x) 
  ...
  if ("gam" %in% method) {
    ...
    # Method 1 .. .compare SD in fishing area and detect when things deviate too much from this SD
